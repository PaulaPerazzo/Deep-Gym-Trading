...
def main(period, time):
    ...
    if period == "pre-pandemic":
        ...
        index_data = pd.read_csv("./data/dji_index_2019.csv")
    
    elif period == "pandemic":
        stock_data = pd.read_csv("./data/dji_stocks_2021.csv")
        index_data = pd.read_csv("./data/dji_index_2021.csv")
    
    elif period == "post-pandemic":
        stock_data = pd.read_csv("./data/dji_stocks_2023.csv")
        index_data = pd.read_csv("./data/dji_index_2023.csv")
    ...
    for step, stocks in enumerate(selected_stocks):
        ...
        file_path = f"./src/dow_jones/logs/testing_dj_{period}_2.txt"
